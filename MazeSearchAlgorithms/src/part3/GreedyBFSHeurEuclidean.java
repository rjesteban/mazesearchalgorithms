 ...
 * @author rjesteban
 */
public class GreedyBFSHeurEuclidean extends InformedSearchAlgo{

    public ArrayList<Point> endPoints;
    
    public GreedyBFSHeurEuclidean(String file) throws IOException {
        super(file);
    ...
    public static void main(String[] args) throws IOException {
        GreedyBFSHeurEuclidean gbfs = new GreedyBFSHeurEuclidean("trialtinynila");
        gbfs.solve();
    }
